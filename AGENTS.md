...
| Navigation                                     | Wired directly in `Navbar`/`NavbarAlt` components — there is no separate `navigation.ts` file in this repo (unlike the generic astro-harness scaffold)                                          |
